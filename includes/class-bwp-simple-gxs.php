...
class BWP_SIMPLE_GXS extends BWP_FRAMEWORK {
	...
	function build_menus()
	{
		...
		{
			add_menu_page(__('BWP Google XML Sitemaps', 'bwp-simple-gxs'), 'Google XML Sitemaps', BWP_GXS_CAPABILITY, BWP_GXS_STATS, array($this, 'build_option_pages'), BWP_GXS_IMAGES . '/icon_menu.png');
